      ...
      >
        <View className="mx-4 h-full flex justify-center align-center space-y-6">
          ...
          <Text className="text-2xl font-extrabold text-center mx-6 text-blue-500">
            Divyangjan - This is an interactive platform.
          </Text>
          <Text className="text-white text-sm text-center mx-4">
            Connect with a diverse and supportive community from around the
            globe. Join interactive forums, engage in meaningful conversations,
            and forge friendships with individuals who share your passion for
            sign language.
          </Text>
          <View>
